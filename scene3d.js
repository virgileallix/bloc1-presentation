...
class GamerSetup3D {
    constructor() {
        ...
        this.projects = {
            ...
            projet3: {
                title: "Mission CNP Assurances — Application Laravel",
                sections: [
                    { type: 'title', text: 'CNP Assurances' },
                    { type: 'subtitle', text: 'Mission professionnelle — 1ère & 2ème année BTS' },
                    { type: 'image', width: 350, height: 200, label: 'CNP Assurances', src: 'images/assureur_logo.png' },

                    { type: 'heading', text: '🏢 Contexte' },
                    { type: 'text', text: 'CNP Assurances est un des premiers assureurs en France.' },
                    { type: 'text', text: "Mission en entreprise sur les deux années de BTS SIO," },
                    { type: 'text', text: "avec intervention sur une application interne Laravel." },

                    { type: 'heading', text: '⚙️ Réalisations — 1ère année' },
                    { type: 'e5-row', label: "Extraction & comparaison de fichiers CSV", period: '2024', tags: ['PHP', 'Données'] },
                    { type: 'e5-row', label: "Mini-jeu Mastermind (PHP)", period: '2024', tags: ['PHP', 'Logique'] },
                    { type: 'e5-row', label: "Correctifs d'incidents rapportés par le client", period: '2024', tags: ['Debug', 'Laravel'] },
                    { type: 'e5-row', label: "Migration Laravel & PHP vers versions récentes", period: '2024-2025', tags: ['Laravel', 'Migration'] },
                    { type: 'e5-row', label: "Évolution de fonctionnalités (application interne)", period: '01/2025 →', tags: ['Laravel', 'Feature'] },

                    { type: 'heading', text: '🔧 Réalisations — 2ème année' },
                    { type: 'e5-row', label: "Développement application Laravel interne (en cours)", period: '01/2025 →', tags: ['Laravel 12', 'PHP 8.2'] },
                    { type: 'text', text: "Ajout de fonctionnalités, corrections, maintenance continue" },

                    { type: 'heading', text: '🛠️ Stack technique' },
                    { type: 'text', text: 'Framework : Laravel / PHP 8.2' },
                    { type: 'text', text: 'Base de données : MySQL' },
                    { type: 'text', text: 'Frontend : Blade, JavaScript, Tailwind CSS' },
                    { type: 'text', text: 'Auth : Laravel Breeze' },
                    { type: 'text', text: 'Outils : Git, Vite' },
