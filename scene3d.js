        ...
        this.projects = {
            ...
            projet3: {
                ...
                sections: [
                    ...
                    { type: 'e5-row', label: "Évolutions sur l'application existante", period: '01/2025 →', tags: ['IHM', 'BDD', 'XML'] },

                    { type: 'heading', text: '🔧 Réalisations — 2ème année' },
                    { type: 'text', text: "Évolution continue de l'application interne :" },
                    { type: 'text', text: "• IHM — Ajout de nouvelles vues et composants d'interface" },
                    { type: 'text', text: "• BDD — Modifications et ajouts de tables / colonnes" },
                    { type: 'text', text: "• XML — Mise à jour des fichiers de configuration et mapping" },

                    { type: 'heading', text: '🛠️ Stack technique' },
                    { type: 'text', text: 'Framework : Laravel / PHP' },
                    { type: 'text', text: 'Base de données : MySQL' },
                    { type: 'text', text: 'Configuration : XML' },
